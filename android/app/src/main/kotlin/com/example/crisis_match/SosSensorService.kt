...
class SosSensorService : Service() {
    ...
    private val sensorListener = object : SensorEventListener {
        override fun onSensorChanged(event: SensorEvent) {
            ...
            if (kotlin.math.abs(gZ - 1.0f) > 1.5f) { // threshold of 1.5g above/below gravity
    ...
    override fun onCreate() {
        ...
        registerReceiver(notificationActionReceiver, IntentFilter(ACTION_SOS_BUTTON), Context.RECEIVER_NOT_EXPORTED)
    ...
    private fun buildNotification(): Notification {
        val chan = NotificationChannel(
            CHANNEL_ID, "CrisisMatch SOS", NotificationManager.IMPORTANCE_HIGH
        )
        ...
        val sosPendingIntent = PendingIntent.getBroadcast(
            this, 0, sosIntent, PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_IMMUTABLE
        )
